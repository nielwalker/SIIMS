...
class WeeklyEntryRequestController extends Controller
{
    ...
    public function create(Request $request)
    {
        try {
            ...
            \Log::error('Error creating weekly entry request: ' . $e->getMessage());
    ...
    public function myPending()
    {
        try {
            ...
            \Log::error('Error fetching weekly entry requests: ' . $e->getMessage());
    ...
    public function completeByWeek(Request $request)
    {
        try {
            ...
            \Log::error('Error completing weekly entry request: ' . $e->getMessage());
            return response()->json(['error' => 'Failed to complete request. Please try again.'], 500);
        }
    }
}
