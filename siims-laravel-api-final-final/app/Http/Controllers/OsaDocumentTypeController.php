...
use App\Http\Requests\OsaDocumentTypeRequest;
use App\Models\DocumentType;
use Illuminate\Http\Request;

class OsaDocumentTypeController extends Controller
{
   /**
     ...
     * @param \App\Http\Requests\OsaDocumentTypeRequest $request
     * @param string $document_type_id
     * @return mixed|\Illuminate\Http\JsonResponse
     */
    public function updateDocumentTypeById(OsaDocumentTypeRequest $request, string $document_type_id)
    {
     ...
     * @return mixed|\Illuminate\Http\JsonResponse
     */
    public function addNewDocumentType(OsaDocumentTypeRequest $request)
    {
        // Get validated credentials
        $validatedCredentials = $request->validated();
