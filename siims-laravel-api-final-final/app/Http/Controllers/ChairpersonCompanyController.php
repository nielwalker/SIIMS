...
use App\Http\Requests\ChairpersonCompanyRequest;
...
class ChairpersonCompanyController extends Controller
{
    ...
    // Store a Company
    public function store(ChairpersonCompanyRequest $request)
    {
