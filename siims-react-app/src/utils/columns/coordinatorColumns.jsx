...
// Coordinator Static Columns
export const getCoordinatorStaticColumns = ({
  authorizeRole,
  pathname,
  selectedStatus,
}) => {
  const columns = [
      ...
      : []),
    {
      ...
      headerClassName: "super-app-theme--header",
      renderCell: (params) => (
        <span className="font-bold">{params.row.total_students}</span>
      ),
    },
...
// Coordinator Action Columns
export const getCoordinatorActionColumns = ({
  authorizeRole,
  handleEditModal,
  handleDeleteModal,
  handleRestore,
