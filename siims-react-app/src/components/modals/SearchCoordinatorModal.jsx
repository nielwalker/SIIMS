...
const SearchCoordinatorModal = ({
  ...
  const handleSelectCoordinator = (coordinator) => {
    ...
    setOjtCoordinatorFullName(coordinator.fullName);
    setOjtCoordinatorMail(coordinator.email);
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axiosClient.get(
        "/api/v1/users/v2/coordinators/search",
        {
          params: {
            query: searchTerm,
          },
...
export default SearchCoordinatorModal;
