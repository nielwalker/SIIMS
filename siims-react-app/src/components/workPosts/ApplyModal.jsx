...
const ApplyModal = ({ isModalOpen, setIsModalOpen, handleConfirmApply }) => {
  return (
    <Dialog
      open={isModalOpen}
    ...
    >
      <Dialog.Panel className="bg-white rounded-xl p-8 shadow-2xl max-w-sm w-full">
        ...
        <Dialog.Description className="text-gray-700 mb-6">
          Are you sure you want to apply for this work post? This action cannot
          be undone.
        </Dialog.Description>
        <div className="flex justify-end gap-4">
          <Button
            onClick={handleConfirmApply}
            className="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold text-sm transition-all duration-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
          >
            Yes
          </Button>
          <Button
