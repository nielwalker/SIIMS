...
import DeanProgramsTableHead from "./DeanProgramsTableHead";
import DeanProgramsTableBody from "./DeanProgramsTableBody";

const DeanProgramsTable = ({
  data,
...
export default DeanProgramsTable;
