...
import AdminCompanyOfficesTableBody from "./AdminCompanyOfficesTableBody";

const AdminCompanyOfficesTable = ({
  data,
...
export default AdminCompanyOfficesTable;
