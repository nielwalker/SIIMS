...
import AdminDocumentTypesTableHead from "./AdminDocumentTypesTableHead";
import AdminDocumentTypesTableBody from "./AdminDocumentTypesTableBody";

const AdminDocumentTypesTable = ({
  data,
...
export default AdminDocumentTypesTable;
