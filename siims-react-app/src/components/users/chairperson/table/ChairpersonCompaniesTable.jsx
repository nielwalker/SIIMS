...
import ChairpersonCompaniesTableBody from "./ChairpersonCompaniesTableBody";

const ChairpersonCompaniesTable = ({
  data,
...
export default ChairpersonCompaniesTable;
