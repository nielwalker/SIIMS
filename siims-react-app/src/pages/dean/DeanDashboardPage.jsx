...
const stats = [
  { label: "Total Students", value: 193, color: "blue", icon: <FaUserGraduate /> },
  { label: "Total Companies", value: 28, color: "green", icon: <Building /> }, // Example icon for Company
];

return (
  <>
    <div className="bg-blue-600 w-100 rounded-md px-2 py-7">
      <Heading level={3} text={"Welcome, DEAN! 👋"} textColor="text-white" />
    </div>
